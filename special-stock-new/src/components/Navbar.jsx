        ...
        <>
            ...
            <header className="text-white px-4 sm:px-6 py-5 bg-[#131313] relative">
                <div className="flex flex-col lg:items-center w-full">
                    {/* Top Row: Mobile Menu + Right Side Icons */}
                    <div className="flex items-center justify-between w-full mb-6">
                        ...
                        <div className="flex-1 flex items-center justify-end gap-x-5">
                            ...
                            <Globe className="h-5 w-5 hover:text-gray-300 cursor-pointer hidden sm:block" />
                            ...
                            {userName ? (
                                <Link
                                    ...
                                    className="bg-white text-black px-6 py-2 rounded-lg font-bold text-sm hover:bg-gray-100 transition-colors hidden sm:flex"
                                >
                                    Dashboard
                                </Link>
                            ) : (
