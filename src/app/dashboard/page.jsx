...
const SpecialStocksDashboard = () => {
    return (
        <div className="flex min-h-screen bg-[#F3F4F6] font-sans text-[#1A1C1E]">
            ...
            {/* 1. Side Navigation (Dark Red Theme) */}
            <aside className="w-64 bg-[#1A0505] text-white flex flex-col p-6 sticky top-0 h-screen">
                ...
                <div className="mt-auto pt-6 border-t border-white/10">
                    <div className="flex items-center gap-3 px-2 mb-6">
                        <div className="w-10 h-10 rounded-full bg-[#EF4444] flex items-center justify-center text-white font-bold">A</div>
                        <div>
            ...
            <main className="flex-1 overflow-y-auto">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                placeholder="Search..."
                                className="pl-10 pr-4 py-2 bg-gray-100 border-none rounded-full text-sm w-64 focus:ring-2 focus:ring-[#EF4444]"
                            />
                        </div>
                ...
                <div className="p-8 space-y-8">
                    ...
                    <div className="bg-[#1A0505] rounded-[24px] p-6 text-white flex items-center justify-between shadow-xl">
                        <div className="flex items-center gap-4">
                        ...
                        <button className="bg-[#EF4444] text-white px-6 py-2 rounded-full font-bold text-sm hover:scale-105 transition-transform">
                            Review Now
                        </button>
                    </div>
                                ...
                                <div className="flex gap-6">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex flex-wrap gap-4 text-[11px] font-bold text-gray-500 mb-4">
                                            <span>By <span className="text-[#1A0505]">Ambient pixel</span></span>
                                            <span>1.07 MB</span>
                                            <span>1280x800</span>
                                        ...
                                        <div className="flex gap-3">
                                            <button className="flex-1 bg-[#1A0505] text-white py-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2">
...
const SidebarItem = ({ icon, label, href = "#", active = false }) => (
    <Link
        href={href}
        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-medium text-sm ${active ? 'bg-[#EF4444] text-white shadow-lg shadow-[#EF4444]/20 font-bold' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}
    >
        {icon}
        <span>{label}</span>
    </Link>
